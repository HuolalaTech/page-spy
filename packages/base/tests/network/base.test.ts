import { SocketState, SocketStoreBase, SocketWrapper } from 'src/socket-base';
import NetworkProxyBase from 'src/network/base';
import RequestItem from 'src/request-item';
