...
(I.hash = function (e, t = 'md5') {
  ...
  (function (e) {
    ...
    (e.HVIGOR_ENGINE_PACKAGE_NAME = '@ohos/hvigor'),
      ...
      (e.HVIGOR_WRAPPER_TOOLS_HOME = u.resolve(
        e.HVIGOR_USER_HOME,
        'wrapper',
        'tools',
      )),
      (e.HVIGOR_WRAPPER_PNPM_SCRIPT_PATH = u.resolve(
        e.HVIGOR_WRAPPER_TOOLS_HOME,
        'node_modules',
        '.bin',
        e.PNPM_TOOL,
      ...
      (e.HVIGOR_PROJECT_CACHES_HOME = u.resolve(
        e.HVIGOR_USER_HOME,
        'project_caches',
      )),
      (e.HVIGOR_PROJECT_ROOT_DIR = process.cwd()),
      (e.HVIGOR_PROJECT_NAME = u.basename(
        (0, s.hash)(e.HVIGOR_PROJECT_ROOT_DIR),
      )),
      (e.HVIGOR_PROJECT_WRAPPER_HOME = u.resolve(
        e.HVIGOR_PROJECT_ROOT_DIR,
        e.HVIGOR,
      )),
      (e.HVIGOR_PROJECT_DEPENDENCIES_HOME = u.resolve(
        e.HVIGOR_PROJECT_CACHES_HOME,
        e.HVIGOR_PROJECT_NAME,
        'workspace',
      )),
      (e.HVIGOR_PROJECT_DEPENDENCY_PACKAGE_JSON_PATH = u.resolve(
        e.HVIGOR_PROJECT_DEPENDENCIES_HOME,
        e.DEFAULT_PACKAGE_JSON,
      )),
      (e.HVIGOR_BOOT_JS_FILE_PATH = u.resolve(
        e.HVIGOR_PROJECT_DEPENDENCIES_HOME,
        'node_modules',
        '@ohos',
        'hvigor',
...
(j.hasNpmPackInPaths = function (e, t) {
  ...
  (j.offlinePluginConversion = function (e, t) {
    return t.startsWith('file:') || t.endsWith('.tgz')
      ? W.resolve(e, z.HVIGOR, t.replace('file:', ''))
      : t;
  }),
  ...
  (function (e) {
    ...
    Object.defineProperty(e, '__esModule', { value: !0 }),
      (e.executeInstallPnpm =
        e.isPnpmAvailable =
        e.environmentHandler =
        e.checkNpmConifg =
        e.PNPM_VERSION =
          void 0);
    const o = r(D.default),
    ...
    (e.PNPM_VERSION = '7.30.0'),
      (e.checkNpmConifg = function () {
        ...
        if (0 !== r.status || !r.stdout)
          return void (0, a.logErrorAndExit)(
      ...
      (e.isPnpmAvailable = function () {
        return (
          !!o.existsSync(i.HVIGOR_WRAPPER_PNPM_SCRIPT_PATH) &&
          (0, s.hasNpmPackInPaths)('pnpm', [i.HVIGOR_WRAPPER_TOOLS_HOME])
        );
      }),
      (e.executeInstallPnpm = function () {
        ...
        !(function () {
          const t = c.resolve(
            i.HVIGOR_WRAPPER_TOOLS_HOME,
            i.DEFAULT_PACKAGE_JSON,
          );
          try {
            o.existsSync(i.HVIGOR_WRAPPER_TOOLS_HOME) ||
              o.mkdirSync(i.HVIGOR_WRAPPER_TOOLS_HOME, { recursive: !0 });
            const n = { dependencies: {} };
            (n.dependencies[i.PNPM] = e.PNPM_VERSION),
              o.writeFileSync(t, JSON.stringify(n));
          } catch (e) {
            (0, a.logErrorAndExit)(
              `Error: EPERM: operation not permitted,create ${t} failed.`,
            );
          }
        })(),
...
'function' == typeof Symbol && 'function' == typeof Symbol.for
  ? ((pe = Symbol.for('graceful-fs.queue')),
    (Ee = Symbol.for('graceful-fs.previous')))
...
function _e() {
  for (var e = Date.now(), t = 0; t < me[pe].length; ++t)
    me[pe][t].length > 2 && ((me[pe][t][3] = e), (me[pe][t][4] = e));
  Be();
}
function Be() {
  if ((clearTimeout(Se), (Se = void 0), 0 !== me[pe].length)) {
    ...
    if (void 0 === u) Ae('RETRY', t.name, n), t.apply(null, n);
      ...
      s >= Math.min(1.2 * c, 100)
        ? (Ae('RETRY', t.name, n), t.apply(null, n.concat([u])))
        : me[pe].push(e);
    }
...
(Pe.makeDir = async (e, t) => (
  Ie(e), Ne.mkdir(e, { mode: Te(t), recursive: !0 })
)),
  (Pe.makeDirSync = (e, t) => (
    Ie(e), Ne.mkdirSync(e, { mode: Te(t), recursive: !0 })
  ));
...
function Ye(e, t, n) {
  const r = n.dereference
    ? (e) => ze.stat(e, { bigint: !0 })
    : (e) => ze.lstat(e, { bigint: !0 });
  return Promise.all([
    r(e),
    r(t).catch((e) => {
...
var et = {
  checkPaths: function (e, t, n, r, u) {
    qe.callbackify(Ye)(e, t, r, (r, o) => {
      ...
      return i.isDirectory() && Ze(e, t)
        ? u(new Error(Qe(e, t, n)))
        : u(null, { srcStat: i, destStat: s });
    });
  },
  checkPathsSync: function (e, t, n, r) {
    const { srcStat: u, destStat: o } = (function (e, t, n) {
      let r;
      const u = n.dereference
          ? (e) => ze.statSync(e, { bigint: !0 })
          : (e) => ze.lstatSync(e, { bigint: !0 }),
        o = u(e);
      try {
        r = u(t);
      } catch (e) {
    ...
    if (o) {
      if (Xe(u, o)) {
        ...
        if ('move' === n && r !== i && r.toLowerCase() === i.toLowerCase())
          return { srcStat: u, destStat: o, isChangingCase: !0 };
        throw new Error('Source and destination must not be the same.');
      }
      if (u.isDirectory() && !o.isDirectory())
        throw new Error(
          `Cannot overwrite non-directory '${t}' with directory '${e}'.`,
        );
      if (!u.isDirectory() && o.isDirectory())
  ...
  checkParentPaths: function e(t, n, r, u, o) {
    ...
    ze.stat(s, { bigint: !0 }, (i, c) =>
      i
        ? 'ENOENT' === i.code
          ? o()
          : o(i)
        : Xe(n, c)
          ? o(new Error(Qe(t, r, u)))
          : e(t, n, s, u, o),
    );
  },
...
function st(e, t, n, r, u) {
  ...
  ut(o, (i, s) =>
    i
      ...
      : s
        ? at(e, t, n, r, u)
        : void rt(o, (o) => (o ? u(o) : at(e, t, n, r, u))),
  );
}
...
var Et = function (e, t, n, r) {
  'function' != typeof n || r
    ...
    it.checkPaths(e, t, 'copy', n, (u, o) => {
      if (u) return r(u);
      const { srcStat: i, destStat: s } = o;
      it.checkParentPaths(e, i, t, 'copy', (u) =>
        u ? r(u) : n.filter ? ct(st, s, e, t, n, r) : st(s, e, t, n, r),
      );
    });
};
const mt = we,
  ...
  if (u.isSymbolicLink())
    return (function (e, t, n, r) {
      ...
      if (e) {
        ...
        if (
          (r.dereference && (e = ht.resolve(process.cwd(), e)),
          Ft.isSrcSubdir(u, e))
        )
          throw new Error(
            `Cannot copy '${u}' to a subdirectory of itself, '${e}'.`,
          );
        if (mt.statSync(n).isDirectory() && Ft.isSrcSubdir(e, u))
          ...
          : u && u.isDirectory()
            ...
            : void t.unlink(e, (r) => {
                if (r) {
                  ...
                  if ('EPERM' === r.code)
                    return Pt ? It(e, t, r, n) : Rt(e, t, r, n);
    ...
    if ('ENOTEMPTY' === r.code || 'EEXIST' === r.code || 'EPERM' === r.code)
      !(function (e, t) {
        if (
          (Bt(e),
          Bt(t),
          t.readdirSync(e).forEach((n) => Mt(_t.join(e, n), t)),
          !Pt)
        ) {
            ...
            : dn.lstat(e, (t) =>
                t
                  ? ((t.message = t.message.replace('lstat', 'ensureSymlink')),
                    n(t))
                  : n(null, { toCwd: e, toDst: fn.relative(r, e) }),
              ),
      );
    }
  },
...
function pr(e, t, n, r, u) {
  return r
    ...
    : n
      ...
      : void dr(t, (r, o) =>
          r ? u(r) : o ? u(new Error('dest already exists.')) : Er(e, t, n, u),
        );
}
function Er(e, t, n, r) {
  sr.rename(e, t, (u) =>
...
const Kr = F.default,
  ...
  eu = (e, t, n) => {
    (Array.isArray(t) ? t : [t]).forEach((t) => {
      if (t)
        throw new Error(
          `Problem with log4js configuration: (${Kr.inspect(e, {
            depth: 5,
          })}) - ${n}`,
        );
    });
...
var tu = {
    ...
    addPreProcessingListener: (e) => {
      Yr.push(e),
        qr(`Added pre-processing listener, now ${Yr.length} listeners`);
    },
    throwExceptionIf: eu,
    anObject: Qr,
  ...
  function i(e, t, n) {
    ...
    return (
      (r = (function (e, t) {
        let n;
        return e
          ? ((n = parseInt(e.substr(1), 10)),
            n > 0 ? t.slice(0, n) : t.slice(n))
          : t;
      })(t, r)),
      (r = (function (e, t) {
        let n;
    ...
    if (t) {
      ...
      Object.keys(t).forEach((n) => {
        yu.throwExceptionIf(
          ...
          yu.throwExceptionIf(
            e,
            yu.not(Cu.indexOf(t[n].colour) > -1),
            `level "${n}".colour must be one of ${Cu.join(', ')}`,
          );
      });
    }
  }),
  ...
  Iu = (e, t, n, r) => {
    ...
    for (let o = Ou(n), { length: i } = o, s = 0; s < i; s++) {
      ...
      if (c instanceof bu) {
        ...
        typeof o !== Pu || t.has(o)
          ? (n[i] = r.call(n, i, o))
          : (t.add(o), (n[i] = Bu), u.push({ k: i, a: [e, t, o, r] }));
...
const Yu = () => Ku && '0' === process.env[qu],
  ...
  Qu = (e, t) => {
    if (
      (Ju('cluster message received from worker ', e, ': ', t),
  ...
  Vu.addListener((e) => {
    (zu.length = 0),
      ...
      Uu || e.disableClustering
        ...
        : Yu()
          ? (Ju('listening for PM2 broadcast messages'),
            process.on('message', Qu))
          : Wu.isMaster
...
var eo = {
    ...
    send: (e) => {
      Xu()
        ? Zu(e)
        : (Ku || (e.cluster = { workerId: Wu.worker.id, worker: process.pid }),
...
lo.configure = function (e, t, n) {
  ...
  return (function (e, t) {
    return (
      'string' == typeof e && (e = [e]),
      (n) => {
        fo(`Checking ${n.categoryName} against ${e}`),
          -1 === e.indexOf(n.categoryName) &&
            (fo('Not excluded, sending to appender'), t(n));
      }
    );
  })(e.exclude, r);
};
...
const Co = p.default;
function Fo(e) {
  return (e = Co.normalize(Co.resolve(e)).split(Co.sep)).length > 0
    ? e[0]
    : null;
}
const go = /[<>:"|?*]/;
      ...
      if (o.isSymbolicLink())
        return (function (e, t, n, r) {
          ...
          if (e) {
            ...
            if (
              (r.dereference && (e = ei.resolve(process.cwd(), e)),
              ri.isSrcSubdir(u, e))
            )
              throw new Error(
                `Cannot copy '${u}' to a subdirectory of itself, '${e}'.`,
              );
            if (Qo.statSync(n).isDirectory() && ri.isSrcSubdir(e, u))
              throw new Error(`Cannot overwrite '${e}' with '${u}'.`);
            return (function (e, t) {
...
function oi(e, t, n, r) {
  return 'function' == typeof Qo.copyFileSync
    ? (Qo.copyFileSync(t, n),
      Qo.chmodSync(n, e.mode),
      r.preserveTimestamps ? ni(n, e.atime, e.mtime) : void 0)
    : (function (e, t, n, r) {
        const u = 65536,
          o = (
            Xo
...
function yi(e, t, n, r, u) {
  ...
  Ei(o, (i, s) =>
    i
      ...
      : s
        ? Fi(e, t, n, r, u)
        : void pi(o, (o) => (o ? u(o) : Fi(e, t, n, r, u))),
  );
}
...
function vi(e, t, n, r) {
  di.chmod(t, e.mode, (u) =>
    u ? r(u) : n.preserveTimestamps ? mi(t, e.atime, e.mtime, r) : r(),
  );
}
function Si(e, t, n, r) {
...
var Oi = function (e, t, n, r) {
  'function' != typeof n || r
    ...
    hi.checkPaths(e, t, 'copy', (u, o) => {
      if (u) return r(u);
      const { srcStat: i, destStat: s } = o;
      hi.checkParentPaths(e, i, t, 'copy', (u) =>
        u ? r(u) : n.filter ? Ci(yi, s, e, t, n, r) : yi(s, e, t, n, r),
      );
    });
};
          ...
          : u && u.isDirectory()
            ...
            : void t.unlink(e, (r) => {
                if (r) {
                  if ('ENOENT' === r.code) return n(null);
                  if ('EPERM' === r.code)
                    return ki ? Ti(e, t, r, n) : Mi(e, t, r, n);
    ...
    if ('ENOTEMPTY' === r.code || 'EEXIST' === r.code || 'EPERM' === r.code)
      !(function (e, t) {
        if (
          (Pi(e),
          Pi(t),
          t.readdirSync(e).forEach((n) => Li(Bi.join(e, n), t)),
          !ki)
        ) {
          return t.rmdirSync(e, t);
        }
          ...
          : o
            ...
            : ls.lstat(e, (t) =>
                t
                  ? ((t.message = t.message.replace('lstat', 'ensureSymlink')),
                    n(t))
                  : n(null, { toCwd: e, toDst: as.relative(r, e) }),
              ),
      );
    }
  },
    ...
    if (await Sc.pathExists(e))
      if (
          ...
          const i = Sc.createWriteStream(t, { mode: n.mode, flags: 'wx' })
            .on('open', () => {
              ...
              const t = Sc.createReadStream(e)
                ...
                .on('error', (t) => {
                  vc(`moveAndMaybeCompressFile: error reading ${e}`, t),
                    i.destroy(t);
                });
            })
            .on('finish', () => {
              ...
              o
                ? (vc(
                  ...
                  Sc.unlink(t)
                    ...
                    .catch((e) => {
                      vc(`moveAndMaybeCompressFile: error deleting ${t}`, e),
                        u(e);
                    }))
                : (vc(`moveAndMaybeCompressFile: error creating ${t}`, e),
                  u(e));
            });
        }).catch(() => {});
      else {
        ...
        try {
          ...
          if (
            (vc(`moveAndMaybeCompressFile: error renaming ${e} to ${t}`, n),
            'ENOENT' !== n.code)
          ) {
...
const bc = Nr.exports('streamroller:RollingFileWriteStream'),
  ...
  Ic = ({
    ...
    return ({ date: e, index: t }) => (
      Cc(`_formatFileName: date=${e}, index=${t}`),
    ...
    let i = [
      (e, t) =>
        e.endsWith('.gz')
          ? (gc('it is gzipped'),
            (t.isCompressed = !0),
            e.slice(0, -1 * '.gz'.length))
          : e,
      t
        ? (t) =>
            t.startsWith(e.name) && t.endsWith(e.ext)
              ? (gc('it starts and ends with the right things'),
                t.slice(e.name.length + 1, -1 * e.ext.length))
              : o
        : (t) =>
            t.startsWith(e.base)
              ? (gc('it starts with the right things'),
      ...
      n
        ...
        : (e, t) =>
            e.match(/^\d+$/)
              ? (gc('it has an index'), (t.index = parseInt(e, 10)), '')
              : e,
    ];
    return (e) => {
...
var Mc = class extends Nc {
  constructor(e, t) {
    if (
      (bc(`constructor: creating RollingFileWriteStream. path=${e}`),
    ...
    0 === e.indexOf(`~${Bc.sep}`) && (e = e.replace('~', Pc.homedir())),
      ...
      '' === this.fileObject.dir &&
        (this.fileObject = Bc.parse(Bc.join(process.cwd(), e))),
      ...
      this.options.pattern &&
        (this.state.currentDate = xc(this.options.pattern, kc())),
  ...
  _setExistingSizeAndDate() {
    try {
      ...
      (this.state.currentSize = e.size),
        this.options.pattern &&
          (this.state.currentDate = xc(this.options.pattern, e.mtime));
    } catch (e) {
      return;
    }
  }
  _parseOption(e) {
    ...
    return (
      bc(`_parseOption: creating stream with option=${JSON.stringify(n)}`), n
    );
  }
  _final(e) {
  ...
  async _clean() {
    ...
    if (
      ...
      bc('_clean: existing files are: ', e),
      this._tooManyFiles(e.length))
    ) {
      const n = e
        .slice(0, e.length - this.options.numToKeep)
        .map((e) => Bc.format({ dir: this.fileObject.dir, base: e.filename }));
      await ((t = n),
      ...
      return (
        ...
        (s.shutdown = function (e) {
          zc.delete(s),
            0 === zc.size &&
              Wc &&
              (process.removeListener('SIGHUP', Kc), (Wc = !1)),
            i.end('', 'utf-8', e);
        }),
        zc.add(s),
...
function Qc(e, t, n, r, u) {
  ...
  const o = (function (e, t, n) {
    ...
    i = function (e) {
      o.writable &&
        (o.write(n(e, u) + Zc, 'utf8') || process.emit('log4js:pause', !0));
    };
  return (
  ...
  roll(e) {
    ...
    function i(n) {
      ...
      if ((ta(`Index of ${n} is ${r}`), 0 === t.backups)) ra.truncateSync(e, 0);
        ...
        ta(`Renaming ${n} -> ${e}.${r + 1}`),
          ra.renameSync(na.join(na.dirname(e), n), `${e}.${r + 1}`);
      }
    }
    ta('Rolling, rolling, rolling'),
      ta('Renaming the old files'),
      ra.readdirSync(na.dirname(e)).filter(r).sort(o).reverse().forEach(i);
  }
  write(e, t) {
    const n = this;
    ta('in write'),
  ...
  return (
    ...
    (function (e, t) {
      ...
      function a(e) {
        n
          ? s(e)
          : (ca('buffering log event because it cannot write at the moment'),
            r.push(e));
      }
      return (
        (function t() {
...
const ya = new Map(),
  Ca = (e, t) => {
    ...
    try {
      ...
      return void da.throwExceptionIf(
        t,
  ...
  Aa = (e, t) => {
    const n = t.appenders[e],
      r = n.type.configure
        ...
        : ((e, t) =>
            ...
            Ca(e, t) ||
            (require.main &&
              Ca(la.join(la.dirname(require.main.filename), e), t)) ||
    ...
    return (
      ...
      r.appender &&
        fa(`DEPRECATION: Appender ${n.type} exports an appender function.`),
      r.shutdown &&
        fa(`DEPRECATION: Appender ${n.type} exports a shutdown function.`),
      fa(`${e}: clustering.isMaster ? ${Da.isMaster()}`),
      fa(`${e}: appenderModule is ${F.default.inspect(r)}`),
      Da.onlyOnMaster(
        () => (
          fa(`calling appenderModule.configure for ${e} / ${n.type}`),
          r.configure(ma.modifyConfig(n), Ea, (e) => ga(e, t), pa)
        ),
        () => {},
      )
    );
...
Sa(),
  da.addListener((e) => {
    da.throwExceptionIf(
      e,
      da.not(da.anObject(e.appenders)),
...
!(function (e) {
  ...
  const l = (e) => (
    ...
    o.has(e)
      ...
      : e.indexOf('.') > 0
        ? (t(`configForCategory: ${e} has hierarchy, searching for parents`),
          l(e.substring(0, e.lastIndexOf('.'))))
        : (t('configForCategory: returning config for default category'),
          l('default'))
  );
  (e.exports = o),
    (e.exports = Object.assign(e.exports, {
      ...
      setLevelForCategory: (e, n) => {
        ...
        if ((t(`setLevelForCategory: found ${r} for ${e}`), !r)) {
          const n = l(e);
          t(
            `setLevelForCategory: no config found for category, found ${n} for parents of ${e}`,
          ),
            (r = { appenders: n.appenders });
        }
        (r.level = n), o.set(e, r);
      },
...
class Ia {
  constructor(e) {
    ...
    (this.category = e),
      (this.context = {}),
      (this.parseCallStack = Na),
      Oa(`Logger created (${this.category}, ${this.level})`);
  }
  get level() {
  ...
  log(e, ...t) {
    ...
    n ||
      (this._log(
        _a.WARN,
        'log4js:logger.log: invalid value for log-level as first parameter given: ',
        e,
      ),
      (n = _a.INFO)),
...
var Va = {
  configure: function () {
    return function (e) {
      $a(`received logEvent, number of events now ${Ha.length + 1}`),
        $a('log event was ', e),
        Ha.push(e);
    };
  },
          ...
          i.on('finish', () => {
            (i.responseTime = new Date() - o),
              i.statusCode &&
                'auto' === t.level &&
                ((r = Ma.INFO),
                i.statusCode >= 300 && (r = Ma.WARN),
                i.statusCode >= 400 && (r = Ma.ERROR)),
              (r = (function (e, t, n) {
                let r = t;
                if (n) {
                  const t = n.find((t) => {
...
function il(e) {
  ...
  if (0 === n)
    return (
      Ua('No appenders with shutdown functions found.'), void 0 !== e && e()
    );
  let r,
    u = 0;
  function o(t) {
    (r = r || t),
      (u += 1),
      Ua(`Appender shutdowns complete: ${u} / ${n}`),
      u >= n && (Ua('All shutdown functions completed.'), e && e(r));
  }
  return (
    Ua(`Found ${n} appenders with shutdown functions.`),
...
let fl = {
  appenders: {
    ...
    info: {
      type: 'stdout',
      layout: { type: 'pattern', pattern: '[%d] > hvigor %[%m%]' },
    },
    'no-pattern-info': {
      type: 'stdout',
    ...
    wrong: {
      type: 'stderr',
      layout: { type: 'pattern', pattern: '[%d] > hvigor %[%p: %m%]' },
    },
    'just-debug': {
      type: 'logLevelFilter',
      appender: 'debug',
...
al.setCategoriesLevel = (e, t) => {
  ...
  for (const r in n)
    (null == t ? void 0 : t.includes(r)) ||
      (Object.prototype.hasOwnProperty.call(n, r) && (n[r].level = e.levelStr));
};
(al.getLevel = () => dl),
  (al.levelMap = new Map([
    ['ALL', ll.levels.ALL],
...
class Fl {
  constructor(e) {
    ml.configure((0, Cl.getConfiguration)()),
      (this._logger = ml.getLogger(e)),
      (this._logger.level = (0, Cl.getLevel)());
  }
  static getLogger(e) {
    return new Fl(e);
  }
...
(xr.HvigorLogger = Fl),
  (xr.evaluateLogLevel = function (e, t) {
    t.debug
      ? e.setLevel(hl.levels.DEBUG)
      : t.warn
        ? e.setLevel(hl.levels.WARN)
        : t.error
          ? e.setLevel(hl.levels.ERROR)
          : e.setLevel(hl.levels.INFO);
  });
var gl =
  (w && w.__importDefault) ||
  function (e) {
...
(X.parseJsonFile = function (e, t = !1, n = 'utf-8') {
  ...
  try {
    ...
    if (t instanceof SyntaxError) {
      ...
      2 === n.length &&
        Ol.errorMessageExit(
          `${n[0].trim()}${wl.default.EOL}\t at ${e}:${n[1].trim()}`,
        );
    }
...
const zl = {
  default() {
    ...
    if (!Al.JudgeUtil.isIgnoreChar(Nl) && !Al.JudgeUtil.isSpaceSeparator(Nl))
      return zl[Il]();
    Wl();
  },
  start() {
  ...
  beforePropertyName() {
    ...
    if (Al.JudgeUtil.isIdStartChar(Nl))
      return (xl += Wl()), void ($l = 'identifierName');
    throw tf(bl.Char, Wl());
  },
  afterPropertyName() {
  ...
  value() {
    ...
    if (void 0 === Nl || !Al.JudgeUtil.isDigitWithoutZero(Nl))
      throw tf(bl.Char, Wl());
    $l = 'numerical';
  },
  numerical() {
    ...
    if (void 0 !== Nl && Al.JudgeUtil.isDigitWithoutZero(Nl))
      return (xl = Wl()), void ($l = 'decimalInteger');
    throw tf(bl.Char, Wl());
  },
  zero() {
    switch (Nl) {
  ...
  decimalPointLeading() {
    if (Al.JudgeUtil.isDigit(Nl))
      return (xl += Wl()), void ($l = 'decimalFraction');
    throw tf(bl.Char, Wl());
  },
  decimalFraction() {
    switch (Nl) {
  ...
  decimalExponent() {
    ...
    if (Al.JudgeUtil.isDigit(Nl))
      return (xl += Wl()), void ($l = 'decimalExponentInteger');
    throw tf(bl.Char, Wl());
  },
  decimalExponentSign() {
    if (Al.JudgeUtil.isDigit(Nl))
  ...
  hexadecimal() {
    if (Al.JudgeUtil.isHexDigit(Nl))
      return (xl += Wl()), void ($l = 'hexadecimalInteger');
    throw tf(bl.Char, Wl());
  },
  hexadecimalInteger() {
      ...
      case '\\':
        return (
          ...
          void (xl += (function () {
              ...
              case 'x':
                return (
                  ...
                  (function () {
                    ...
                    if (((e += Wl()), (t = Ul()), !Al.JudgeUtil.isHexDigit(t)))
                      throw tf(bl.Char, Wl());
            ...
            if (void 0 === e || Al.JudgeUtil.isDigitWithoutZero(e))
              throw tf(bl.Char, Wl());
            return Wl();
          })())
        );
...
function Zl() {
  ...
  if (
    (jl && 'object' == typeof e && ((e._line = Ml), (e._column = Ll)),
    void 0 === kl)
  )
    kl = e;
  else {
    ...
    Array.isArray(t)
      ...
      : (t[Pl] =
          jl && 'object' != typeof e
            ? { value: e, _line: Ml, _column: Ll }
            : e);
  }
  !(function (e) {
    if (e && 'object' == typeof e)
      Tl.push(e),
        (Il = Array.isArray(e) ? 'beforeArrayValue' : 'beforePropertyName');
    else {
...
function tf(e, t) {
  ...
  switch (e) {
    case bl.Char:
      n =
        void 0 === t
          ? `JSON5: invalid end of input at ${Ml}:${Ll}`
          : `JSON5: invalid character '${ef(t)}' at ${Ml}:${Ll}`;
      break;
    case bl.EOF:
...
var sf =
  (Y.cleanWorkSpace =
  Ff =
  Y.executeInstallHvigor =
  yf =
  Y.isHvigorInstalled =
  mf =
  Y.isAllDependenciesInstalled =
    void 0);
...
var mf = (Y.isAllDependenciesInstalled = function () {
  ...
  for (const e in null == pf ? void 0 : pf.dependencies)
    if (
      !(0, ff.hasNpmPackInPaths)(e, [lf.HVIGOR_PROJECT_DEPENDENCIES_HOME]) ||
      !hf(e, pf, Ef)
    )
      return !1;
  return !0;
...
function hf(e, t, n) {
  return (
    ...
    (0, ff.offlinePluginConversion)(
      lf.HVIGOR_PROJECT_ROOT_DIR,
      t.dependencies[e],
    ) === n.dependencies[e]
  );
}
var yf = (Y.isHvigorInstalled = function () {
  return (
    (pf = gf()),
    (Ef = Af()),
    (0, ff.hasNpmPackInPaths)(lf.HVIGOR_ENGINE_PACKAGE_NAME, [
      lf.HVIGOR_PROJECT_DEPENDENCIES_HOME,
    ]) &&
      (0, ff.offlinePluginConversion)(
        lf.HVIGOR_PROJECT_ROOT_DIR,
        pf.hvigorVersion,
      ) === Ef.dependencies[lf.HVIGOR_ENGINE_PACKAGE_NAME]
  );
});
const Cf = {
...
var Ff = (Y.executeInstallHvigor = function () {
  ...
  e.dependencies[lf.HVIGOR_ENGINE_PACKAGE_NAME] = (0,
  ff.offlinePluginConversion)(lf.HVIGOR_PROJECT_ROOT_DIR, pf.hvigorVersion);
  try {
    cf.mkdirSync(lf.HVIGOR_PROJECT_DEPENDENCIES_HOME, { recursive: !0 });
    const t = af.resolve(
      lf.HVIGOR_PROJECT_DEPENDENCIES_HOME,
      lf.DEFAULT_PACKAGE_JSON,
    );
...
function gf() {
  const e = af.resolve(
    lf.HVIGOR_PROJECT_WRAPPER_HOME,
    lf.DEFAULT_HVIGOR_CONFIG_JSON_FILE_NAME,
  );
  return (
    cf.existsSync(e) ||
      (0, df.logErrorAndExit)(`Error: Hvigor config file ${e} does not exist.`),
    (0, Df.parseJsonFile)(e)
  );
}
function Af() {
...
sf = Y.cleanWorkSpace = function () {
  if (
    ((0, df.logInfoPrintConsole)('Hvigor cleaning...'),
    !cf.existsSync(lf.HVIGOR_PROJECT_DEPENDENCIES_HOME))
  )
    return;
  const e = cf.readdirSync(lf.HVIGOR_PROJECT_DEPENDENCIES_HOME);
  if (e && 0 !== e.length) {
    cf.existsSync(lf.HVIGOR_BOOT_JS_FILE_PATH) &&
      (0, ff.executeCommand)(
        process.argv[0],
        [lf.HVIGOR_BOOT_JS_FILE_PATH, '--stop-daemon'],
        {},
      );
    try {
      e.forEach((e) => {
...
(bf = vf.executeBuild =
  function () {
    const e = Pf.resolve(
      _f.HVIGOR_PROJECT_DEPENDENCIES_HOME,
      'node_modules',
      '@ohos',
      'hvigor',
      'bin',
    ...
    try {
      ...
      (0, kf.logErrorAndExit)(
        `Error: ENOENT: no such file ${e},delete ${_f.HVIGOR_PROJECT_DEPENDENCIES_HOME} and retry.`,
      );
    }
  }),
  (function () {
    if (
      (O.checkNpmConifg(),
      O.environmentHandler(),
      O.isPnpmAvailable() || O.executeInstallPnpm(),
      yf() && mf())
    )
      bf();
    else {
